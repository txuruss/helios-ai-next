...
export const metadata = { title: 'Relevance AI — Mission Control' }

const STATUS_TONE: Record<string, string> = {
  queued: '#6a6a6e', running: '#3b9eff', complete: '#22d093', failed: '#ff8a7a',
}

export default async function AdminRelevancePage() {
  await requireAdmin({ path: '/admin/relevance-ai' })
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-1">
        ...
        <h1 className="text-[22px] font-semibold">Relevance AI</h1>
        <p className="text-[13.5px] text-[#9a9a9d]">
          Recent agent and workforce runs across business audits, QA, and outreach. Live Relevance integration runs through the existing server-only client.
        </p>
      </div>
      ...
      <LegacyNote href="/dashboard/agents" label="Open legacy agents workspace" />
    </div>
  )
}
