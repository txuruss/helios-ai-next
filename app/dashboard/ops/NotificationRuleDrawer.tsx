...
export default function NotificationRuleDrawer({ rule, members, onClose, onSaved }: Props) {
  return (
    <>
      ...
      <aside className="fixed inset-y-0 right-0 w-[520px] max-w-[100vw] z-50
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5">
          <NotificationRuleForm rule={rule} members={members} onClose={onClose} onSaved={onSaved} />
        </div>
      </aside>
    </>
  )
