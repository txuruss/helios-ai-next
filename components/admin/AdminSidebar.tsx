...
import {
  Compass, BarChart2, Users, Building2, Settings, LogOut, X, ClipboardList, Rocket, Megaphone,
} from 'lucide-react'

const ICONS: Record<string, React.ComponentType<{ size?: number; className?: string }>> = {
  Compass, BarChart2, Users, Building2, Settings, ClipboardList, Rocket, Megaphone,
}
