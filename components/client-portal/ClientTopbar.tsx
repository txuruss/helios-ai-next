...
export default function ClientTopbar({ title, session, onMenuToggle }: Props) {
    ...
    <header className="h-[60px] shrink-0 flex items-center justify-between gap-4 px-5
      ...
      <div className="flex items-center gap-3 min-w-0">
        ...
        <div className="flex items-center gap-1.5 min-w-0">
          <span className="text-[13px] text-[#6a6a6e] hidden sm:inline whitespace-nowrap truncate">{session.businessName}</span>
        ...
        <div className="relative">
          <button onClick={() => setOpen((o) => !o)}
            ...
            <div className="hidden sm:flex flex-col items-start leading-none">
              ...
              <span className="text-[10.5px] text-[#6a6a6e] capitalize">{session.role}</span>
            </div>
          ...
          {open && (
            <>
              ...
              <div className="absolute right-0 top-[calc(100%+8px)] min-w-[200px] z-20
                ...
                <Link href="/client/settings" onClick={() => setOpen(false)}
