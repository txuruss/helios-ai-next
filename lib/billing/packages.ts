...
export const PACKAGES: Record<PlanId, PackageDef> = {
  ...
  scale: {
    ...
    positioning:     'A complete AI operating system for inquiries, bookings, follow-ups, and lead management.',
    primaryOutcome:  'Give your business one AI-powered command center for inquiries, bookings, follow-ups, and customer lead visibility.',
    setupIncludes: [
